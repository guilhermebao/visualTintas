<template>
  <div class="company">
    ...
    <p>Desde de 2002 utilizamos o PPQ-Programa de Padronizaqäo e Qualidade como forma de maior integracäo da EQUIPE, o que se tornou um grande diferencial entre tantas outras empresas do ramo.</p>
    <p>A VISUAL TINTAS trabalha com seriedade, sempre buscando oferecer para seus clientes produtos da melhor qualidade. para isso contamos com uma Equipe de colaboradores preparados para melhor atendimento aos seus consumidores. </p>
    <p>MISSÄO: </p>
    <p>"A Razäo de Existir da Visual Tintas é Repassar aos Clientes Tintas Automotivas e Complementos de Qualidade com Alto Padräo de Atendimento. Buscando Sempre a Satisfacão Geral."</p>
  </div>
</template>
